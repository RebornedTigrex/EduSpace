...
// Предполагается, что style_col — это ваш enum/typedef для ImGuiCol_*
...
public:
    ...
    void text_clipped(
        ...
        const ImVec2& align = ImVec2(0.f, 0.f),
    ...
    // Тени (пока упрощённые реализации)
    void shadow_rect(
        ImDrawList* draw_list,
